...
| :--- | :--- | :--- |
| **[`circuit-breaker.test.ts`](file:///c:/Users/junin/Documents/projetos/anistream/src/__tests__/circuit-breaker.test.ts)** | [`src/lib/api/circuit-breaker.ts`](file:///c:/Users/junin/Documents/projetos/anistream/src/lib/api/circuit-breaker.ts) | Validação da máquina de estados (CLOSED, OPEN, HALF_OPEN) do disjuntor de APIs externas. |
| **[`crypto.test.ts`](file:///c:/Users/junin/Documents/projetos/anistream/src/__tests__/crypto.test.ts)** | [`src/lib/security/crypto.ts`](file:///c:/Users/junin/Documents/projetos/anistream/src/lib/security/crypto.ts) | Criptografia/descriptografia AES-256-GCM de URLs de vídeo e headers sensíveis. |
