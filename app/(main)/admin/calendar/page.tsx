  ...
  return (
    <div className="space-y-5 pb-28">
      ...
      <AdminPanel>
        ...
        <div className="p-3"><Preview calendar={state.preview} /></div>
      </AdminPanel>
