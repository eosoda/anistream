  ...
  return (
    <div className="space-y-6">
      ...
      <AdminFilterBar label="Filtrar catálogo">
        <label className="min-w-0 flex-1"><span>Pesquisar</span><span className="relative"><Search size={15} aria-hidden="true" className="absolute left-2.5 top-2.5 text-[var(--admin-dim)]" /><input value={search} onChange={(event) => { setSearch(event.currentTarget.value); setPage(1); }} placeholder="Título, título original ou slug" className="admin-search-input w-full" /></span></label>
